...
export enum RoutesAlias {
  ...
  BookList = '/books/booklist', // 图书列表
  AddBook = '/books/addbook', // 添加图书

  BorrowRecords = '/borrow/borrow_records', // 借阅记录
  BookBorrow = '/borrow/book_borrow', // 图书借阅
  PersonalRecords = '/borrow/personal_records', // 个人借阅记录
...
// 主页路由
export const HOME_PAGE = RoutesAlias.HOME
